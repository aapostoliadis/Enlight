...
<!--
    <link rel="stylesheet" type="text/css" href="http://cdn.sencha.io/ext-4.0.7-gpl/ext-all.css" />
-->
...
<!--
    ...
    <script type="text/javascript" charset="utf-8" src="http://cdn.sencha.io/ext-4.0.7-gpl/locale/ext-lang-de.js"></script>
-->
